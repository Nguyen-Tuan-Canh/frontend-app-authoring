...
const messages = defineMessages({
  ...
  clearUsageKeyToSearch: {
    ...
    defaultMessage: 'Đang hiển thị một khối, hãy xóa bộ lọc để tìm kiếm',
  ...
  'blockTagsFilter.incomplete': {
    ...
    defaultMessage: 'Rất tiếc, không thể tải tất cả thẻ',
  ...
  'blockType.openassessment': {
    ...
    defaultMessage: 'Bài tự luận chấm điểm',
  ...
  'blockType.choiceresponse': {
    ...
    defaultMessage: 'Trắc nghiệm một đáp án',
  ...
  'blockType.multiplechoiceresponse': {
    ...
    defaultMessage: 'Hộp chọn (Checkboxes)',
  ...
  submitSearchTagsByKeyword: {
    ...
    defaultMessage: 'Thực hiện tìm kiếm theo từ khóa thẻ',
  ...
  openProblemSubmenuAlt: {
    ...
    defaultMessage: 'Mở bộ lọc kiểu bài tập',
