const descriptions = {
  ...
  deleteModalDescription: {
    ...
    defaultMessage: 'Việc xóa một giáo trình không thể hoàn tác và mọi tham chiếu đến giáo trình đó trong điều hướng nội dung khóa học cũng sẽ bị xóa.',
