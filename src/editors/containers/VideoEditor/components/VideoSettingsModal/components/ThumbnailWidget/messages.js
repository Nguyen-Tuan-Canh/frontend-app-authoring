...
const messages = defineMessages({
  ...
  unavailableMessage: {
    ...
    defaultMessage:
      'Hãy chọn một video từ thư viện của bạn để bật tính năng này (chỉ áp dụng cho các khóa học chạy trên trang edx.org).',
  ...
  addThumbnail: {
    ...
    defaultMessage: 'Tải lên một hình ảnh để hiển thị cho học viên trước khi phát video.',
  ...
  thumbnailAltText: {
    ...
    defaultMessage: 'Hình ảnh dùng làm ảnh thu nhỏ cho video',
  ...
  fileSizeError: {
    ...
    defaultMessage:
      'Kích thước tệp ảnh thu nhỏ phải lớn hơn 2 KB và nhỏ hơn 2 MB. Vui lòng chỉnh lại kích thước hình và thử lại.',
    description:
