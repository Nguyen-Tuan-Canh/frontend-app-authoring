...
const messages = defineMessages({
  ...
  validateErrorBody: {
    ...
    defaultMessage: 'Vui lòng kiểm tra lại thông tin và thử lại.',
  ...
  durationDescription: {
    ...
    defaultMessage: 'Thiết lập một đoạn cụ thể của video để phát.',
  ...
  fullVideoLength: {
    ...
    defaultMessage: 'Toàn bộ thời lượng video',
  ...
  startsAt: {
    ...
    defaultMessage: 'Bắt đầu lúc {startTime}',
  ...
  noTranscriptsAdded: {
    ...
    defaultMessage: 'Chưa thêm phụ đề nào',
