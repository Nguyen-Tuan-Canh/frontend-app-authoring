...
const messages = defineMessages({
  ...
  uploadImageFilesAndUploads: {
    ...
    defaultMessage: 'tệp và nội dung đã tải lên',
  },
  ...
  uploadImageDropzoneAlt: {
    ...
    defaultMessage: 'Ảnh đã tải lên cho khóa học',
  },
  uploadImageEmpty: {
    id: 'course-authoring.schedule-section.introducing.upload-image.empty',
    defaultMessage: 'Khóa học của bạn hiện chưa có ảnh. Vui lòng tải lên một ảnh (định dạng JPEG hoặc PNG, kích thước tối thiểu được đề xuất là rộng 375px và cao 200px).',
  },
  uploadImageIconAlt: {
  ...
  uploadImageBodyFilled: {
    ...
    defaultMessage: 'Bạn có thể quản lý ảnh này cùng với tất cả {hyperlink} khác của mình.',
  },
