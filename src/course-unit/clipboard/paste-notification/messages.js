...
const messages = defineMessages({
  hasConflictingErrorsTitle: {
    ...
    defaultMessage: 'Cần cập nhật tệp thủ công.',
  ...
  hasConflictingErrorsDescription: {
    ...
    defaultMessage: 'Các tệp sau cần được cập nhật thủ công để các thành phần hoạt động như mong muốn:',
  ...
  hasErrorsDescription: {
    ...
    defaultMessage: 'Không thể thêm các tệp bắt buộc sau vào khóa học:',
  ...
  hasNewFilesTitle: {
    ...
    defaultMessage: 'Đã thêm tệp mới vào Files & Uploads.',
