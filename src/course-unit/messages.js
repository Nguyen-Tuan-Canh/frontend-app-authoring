...
const messages = defineMessages({
  ...
  alertUnpublishedVersion: {
    ...
    defaultMessage: 'Lưu ý: Phiên bản đã xuất bản gần nhất của đơn vị học này đang hiển thị cho học viên. Khi xuất bản các thay đổi, bạn sẽ làm thay đổi trải nghiệm của học viên.',
  },
  pasteButtonText: {
  ...
  alertMoveCancelTitle: {
    ...
    defaultMessage: 'Đã hủy thao tác di chuyển',
  ...
  newLocationButton: {
    ...
    defaultMessage: 'Đi tới vị trí mới',
  ...
  alertLibraryUnitReadOnlyText: {
    ...
    defaultMessage: 'Đơn vị học này chỉ có thể được chỉnh sửa từ {link}.',
