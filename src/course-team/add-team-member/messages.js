...
const messages = defineMessages({
  title: {
    ...
    defaultMessage: 'Thêm thành viên cho khóa học này',
  },
  description: {
    id: 'course-authoring.course-team.add-team-member.description',
    defaultMessage: 'Việc thêm thành viên giúp quá trình xây dựng khóa học trở nên cộng tác hơn. Người dùng cần đăng ký Studio và có tài khoản đang hoạt động.',
  },
  button: {
